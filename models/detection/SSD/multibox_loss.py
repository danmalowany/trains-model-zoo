...
class SSDLoss(nn.Module):
    ...
    def forward(self, loc_preds, loc_targets, cls_preds, cls_targets):
        ...
        # Losses are per positive box (averaged)
        # The normalization coeff is the number of positives. If no positives, we set it to 1.
        normalization_factor = num_pos if num_pos else 1

        return {'loc_loss': loc_loss/normalization_factor, 'cls_loss': cls_loss/normalization_factor}
