...
def get_fasterrcnn(num_classes, backbone_name='resnet50'):
    ...
    model = fasterrcnn_fpn(backbone_name=backbone_name, pretrained_backbone=True, num_classes=num_classes)
    return model


def fasterrcnn_fpn(backbone_name='resnet50', num_classes=91, pretrained_backbone=True, **kwargs):
